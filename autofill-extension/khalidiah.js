(() => {
  ...
  function fillKhalidiah(data) {
    ...
    blocks.forEach((block, idx) => {
      ...
      setDropdown(block.querySelector('.samo-passport-state'), p.citizenship || p.nationality || '84');
  ...
  if (document.readyState === 'loading') {
    document.addEventListener('DOMContentLoaded', () => createButton(fillKhalidiah));
  } else {
    createButton(fillKhalidiah);
  }
})();
